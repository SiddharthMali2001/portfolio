...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen flex items-center relative overflow-hidden bg-white dark:bg-primary">
      {/* Background elements */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <motion.div
          className="absolute left-1/3 top-1/4 w-72 h-72 rounded-full bg-gradient-to-tr from-gray-300 to-transparent opacity-20 blur-xl dark:from-[#202020] dark:opacity-30"
          animate={{
            x: [0, 10, 0],
            y: [0, -10, 0],
            scale: [1, 1.05, 1]
        ...
        />
        <motion.div
          className="absolute right-1/4 bottom-1/3 w-64 h-64 rounded-full bg-gradient-to-bl from-gray-400 to-transparent opacity-15 blur-xl dark:from-[#252525] dark:opacity-20"
          animate={{
            x: [0, -15, 0],
            y: [0, 15, 0],
            scale: [1, 1.03, 1]
      ...
      <div className="absolute top-0 left-0 right-0 bg-white/50 dark:bg-primary/50 flex justify-between items-center px-6 py-1 border-b border-gray-300/30 dark:border-muted/30">
        <div className="font-mono text-xs text-gray-500 dark:text-muted">{formatTime(currentTime)}-{formatDate(currentTime)}</div>
        <div className="font-mono text-xs text-gray-500 dark:text-muted">~SIDDHARTH MALI</div>
      </div>
      ...
      <div className="container-custom"> {/* Main container for hero content */}
        ...
        >
          <motion.div variants={childVariants} className="mb-4">
            <div className="inline-block w-12 h-[1px] bg-gray-400 dark:bg-muted mr-4 align-middle"></div>
            <span className="text-gray-500 dark:text-muted text-sm font-mono">PORTFOLIO </span>
          </motion.div>
          ...
          >
            <div className="mb-2 font-mono text-sm tracking-wider text-gray-600 dark:text-muted">HELLO, I'M</div>
            <div className="nothing-headline font-mono tracking-wide text-gray-900 dark:text-accent">
              <DottedText text="SIDDHARTH MALI" />
            </div>
          ...
          <motion.p
            variants={childVariants}
            className="text-gray-600 dark:text-muted text-lg md:text-xl mb-10 max-w-xl"
          >
          ...
          >
            <a href="https://github.com/SiddharthMali2001" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-gray-600 dark:text-muted hover:text-gray-900 dark:hover:text-light transition-colors">
            ...
            <a href="https://www.linkedin.com/in/siddharthmali2001/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-gray-600 dark:text-muted hover:text-gray-900 dark:hover:text-light transition-colors">
              <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          >
            <div className="mona-gradient-btn">
            ...
            <a href="#badges" className="nothing-btn">
              BADGES
            ...
            <a href="/public/SIDDHARTH-MALI_Resume.pdf" target="_blank" rel="noopener noreferrer" className="nothing-btn">
              RESUME
              <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
