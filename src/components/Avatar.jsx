...
const Avatar = () => {
  ...
  const styles = { 
    ...
    head: {
      width: HEAD_WIDTH,
      height: HEAD_HEIGHT,
      backgroundColor: isDark ? '#cccccc' : '#b3b3b3',
      borderRadius: '50%',
      position: 'absolute',
      top: HEAD_TOP_OFFSET,
      left: '50%',
    ...
    hair: {
      width: 110,
      height: 65,
      backgroundColor: isDark ? '#202020' : '#1a1a1a',
      ...
      transform: 'translateX(-50%)',
      zIndex: 3,
      borderTop: isDark ? '2px solid #1a1a1a' : '2px solid #0d0d0d',
    },
    headphoneBand: {
      width: 130,
      height: 30,
      backgroundColor: isDark ? '#202020' : '#1a1a1a',
      border: isDark ? '3px solid #1a1a1a' : '3px solid #0d0d0d',
    ...
    leftEarcup: {
      width: 35,
      height: 45,
      backgroundColor: isDark ? '#252525' : '#1f1f1f',
      border: isDark ? '3px solid #1a1a1a' : '3px solid #0d0d0d',
      borderRadius: '12px',
      position: 'absolute',
      top: 50,
    ...
    leftEyeSocket: {
      ...
      backgroundColor: isDark ? '#f0f0f0' : '#e8e8e8',
      borderRadius: '40%',
      position: 'absolute',
      ...
      <div style={styles.head}>
        ...
        {isDark && (
          <div style={{
            ...
            <svg width="50" height="30" viewBox="0 0 50 25" xmlns="http://www.w3.org/2000/svg">
              <path 
                d="M 10 8 Q 25 18 40 8" 
                stroke="#000000" 
                strokeWidth="3" 
                fill="none" 
                strokeLinecap="round"
